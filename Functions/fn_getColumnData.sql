create or replace FUNCTION getColumnData (SHORTNAME IN VARCHAR2,
...
xmlns:xs="http://www.w3.org/2001/XMLSchema">
  <soap:Body>
    <getColumnData xmlns="http://general.service.webservices.skire.com/" soap:encondingStyle="http://schemas.xmlsoap.org/soap/encoding/">
       ...
       <columnName xsi:type="xsd:string">'||COLUMNNAME||'</columnName>
    </getColumnData>
  </soap:Body>
  </soap:Envelope>';
